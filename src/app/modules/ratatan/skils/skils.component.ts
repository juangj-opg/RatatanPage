  ...
  skills: SkillSlot[] = [
    ...
    // Rayo
    {
      skills: [
        ...
        {
          title: 'Búmeran Aquarayo*',
          elementType: 'duo',
          srcImg: 'icn_ratacarta05_duo01m.png',
        },
        {
          title: 'Vendaval Áureo*',
          elementType: 'duo',
  ...
  cards: CardSlot[] = [
    {
      ...
      cards: [
        ...
        {
          title: 'Megabola Venenosa*',
          desc: 'Cada vez envenenas a un enemigo, el poder de este aumenta. Al tener exito con un comando, la Megabola Venenosa saldrá disparada hacia delante, explotando y causando un daño adicional. Traducido por Kyrox, cambiar más adelante.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
    ...
    },
    {
      ...
      cards: [
        ...
        {
          title: 'Burbuja Hirviente*',
          desc: 'Al usar un ataque o una habilidad, tu Ratatan disparará cuatro bolas de agua rebotantes. El daño escalará según el valor de la Barrera. Traducido por Kyrox, cambiar más adelante.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
        ...
        {
          title: 'Cura Glacial*',
          desc: 'La vida del Cobun recupera 10 de vida continuamente mientras tengas Barrera. La cantidad de vida recuperada escalará según el valor de la Barrera. Traducido por Kyrox, cambiar más adelante.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
    ...
    },
    {
      ...
      cards: [
        ...
        {
          title: 'Hombro Gélido*',
          desc: 'Reduce el el tiempo de recarga de las Bolas Gélidas y añade un 100% de la vida máxima del Ratatan como daño. Cada vez que un ememigo quede Congelado, la vida del Ratatan sube 5 (hasta 500). Traducido por Kyrox.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
    ...
    },
    {
      ...
      cards: [
        ...
        {
          title: 'Corte Ventopútrido*',
          desc: 'Tus ataques siempre son críticos contra enemigos Envenenados. Cada vez que asestas un Golpe Crítico, obtienes 1 token. Traducido por Kyrox, cambiar más adelante.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
    ...
    },
    {
      ...
      cards: [
        ...
        {
          title: 'Búmeran Aquarayo*',
          desc: 'Cuando el Búmeran impacta, rayos caen a ambos lados, causando daño e infligiendo Electrocutado. El estado Electrocutado también aplica un debuff que aumenta el daño que reciben los enemigos. Traducido por Kyrox, cambiar más adelante.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
        ...
        {
          title: 'Vendaval Áureo*',
          desc: 'Tu máximo MP sube en 1 (máximo 200). El poder de tus Técnicas aumentan según el número de tokens que tengas actualmente. Traducido por Kyrox, cambiar más adelante.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
    ...
    },
    {
      ...
      cards: [
        ...
        {
          title: 'Pyronado*',
          desc: 'La habilidad de Tornado se transforma en uno con llamas cuando es usado. Este inflige Quemado y un daño equivalente al porcentaje de la vida máxima del Ratatan. Traducido por Kyrox, cambiar más adelante.',
          element: 'Duo',
          rarityLvl: [4],
          variableLvl: [0],
